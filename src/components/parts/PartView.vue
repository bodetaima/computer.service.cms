                    ...
                    <div class="col-md-8 order-md-1">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div role="alert" style="color: red; font-size: 10px" v-if="errors.has('name')">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div role="alert" style="color: red; font-size: 10px" v-if="errors.has('type')">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div role="alert" style="color: red; font-size: 10px" v-if="errors.has('price')">
